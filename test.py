...
class TestDCAE(unittest.TestCase):
    ...
    def test_compress_decompress_cycle(self):
        ...
        self.assertEqual(len(strings), 2, "Compressed output should contain strings for y and z")
        ...
        self.assertTrue(x_hat.min() >= 0 and x_hat.max() <= 1, 
                        "Output image values out of range [0, 1]")
        
        print(f"Compress/Decompress cycle successful. Input: {x.shape} -> Output: {x_hat.shape}")
